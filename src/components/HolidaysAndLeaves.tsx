...
export default function HolidaysAndLeaves() {
  const { theme, holidays, setHolidays, nowIso, locale } = useOxyFlow();
  ...
  return (
    <div className={`p-6 rounded-[2rem] border shadow-2xl flex flex-col gap-6 transition-all duration-300 ${
      theme === 'light' ? 'bg-[#FCFAF8] border-[#DFD7CB] shadow-[#DFD7CB]' : 'bg-[#FCFAF8]/5 border-white/10'
    }`}>
      <div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mt-1.5">
          <h2 className={`font-sans font-bold text-2xl flex items-center gap-2 ${
