...
export default function BaseGui({ state, isCondensed }: { state: GuiState; isCondensed: boolean }) {
  ...
  return (
    <div id="gui-container" className={`grid grid-cols-1 ${isCondensed ? '' : 'lg:grid-cols-12'} gap-8 ${theme === 'light' ? 'text-[#2C2421]' : 'text-slate-300'
      }`}>
        ...
        <AnimatePresence mode="wait">
          {activeLog ? (
            <motion.div
              ...
              className={`p-6 rounded-[2rem] border shadow-2xl flex flex-col ${isCondensed ? 'items-start' : 'sm:flex-row items-center justify-between'} gap-4 relative overflow-hidden backdrop-blur-md transition-all ${theme === 'light'
            ...
            >
              ...
              <div className={`flex items-center gap-4 z-10 ${isCondensed ? 'w-full' : 'sm:w-auto w-full'}`}>
                <div className="relative">
                  <div className={`w-12 h-12 rounded-2xl flex items-center justify-center border shadow-lg animate-spin-slow shrink-0 ${theme === 'light' ? 'bg-[#FCFAF8] border-[#DFD7CB] text-orange-500' : 'bg-[#FCFAF8]/10 border-white/10 text-orange-450'
                    }`}>
                ...
                <div className="min-w-0">
                  ...
                  <h4 className={`font-sans font-extrabold text-lg mt-1 leading-snug truncate ${theme === 'light' ? 'text-[#2C2421]' : 'text-white'
              ...
              <div className={`flex items-center gap-4 z-10 w-full ${isCondensed ? 'justify-between pt-4 border-t' : 'sm:w-auto justify-between sm:justify-end border-t sm:border-0 pt-3 sm:pt-0'} ${theme === 'light' ? 'border-[#DFD7CB]' : 'border-white/10'
                }`}>
            ...
            <div id="active-timer-idle-banner" className={`backdrop-blur-md rounded-[2rem] p-6 border flex flex-col ${isCondensed ? 'gap-6' : 'md:flex-row items-center justify-between gap-4'} transition-all duration-300 ${theme === 'light'
                ? 'bg-[#FCFAF8] border-[#DFD7CB] shadow-sm shadow-[#DFD7CB]/50'
                : 'bg-[#FCFAF8]/5 border-white/10'
              }`}>
              <div className="flex items-center gap-4">
                <div className={`w-10 h-10 border rounded-xl flex items-center justify-center shrink-0 ${theme === 'light' ? 'bg-[#F4EFEA] border-[#DFD7CB]' : 'bg-[#FCFAF8]/5 border-white/10'
                  }`}>
