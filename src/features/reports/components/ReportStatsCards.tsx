  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      <div className={`p-5 rounded-3xl border transition-all ${theme === 'light' ? 'bg-teal-50/30 border-teal-100 shadow-sm shadow-teal-50' : 'bg-[#FCFAF8]/5 border-white/10'
        ...
        <p className="text-[10px] font-mono tracking-wider text-[#9B8C83] uppercase">{translate(locale, 'report', 'TodayTotal', customTranslations)}</p>
        ...
        <p className="text-[10px] text-[#8A7A71] mt-1">{translate(locale, 'report', 'LogsSumToday', customTranslations)}</p>
      </div>
      ...
      <div className={`p-5 rounded-3xl border transition-all ${theme === 'light' ? 'bg-orange-50/30 border-orange-150 shadow-sm shadow-orange-50' : 'bg-[#FCFAF8]/5 border-white/10'
        ...
        <p className="text-[10px] font-mono tracking-wider text-[#9B8C83] uppercase">{translate(locale, 'report', 'WeekTotal', customTranslations)}</p>
        ...
        <p className="text-[10px] text-[#8A7A71] mt-1">{translate(locale, 'report', 'FromMondayUntilNow', customTranslations)}</p>
      </div>
      ...
      <div className={`p-5 rounded-3xl border transition-all ${theme === 'light' ? 'bg-rose-50/30 border-rose-150 shadow-sm shadow-rose-50' : 'bg-[#FCFAF8]/5 border-white/10'
        ...
        <p className="text-[10px] font-mono tracking-wider text-[#9B8C83] uppercase">{translate(locale, 'report', 'MonthTotal', customTranslations)}</p>
        ...
        <p className="text-[10px] text-[#8A7A71] mt-1">{translate(locale, 'report', 'AccumulatedMonthSeconds', customTranslations)}</p>
      </div>
    </div>
  );
}
