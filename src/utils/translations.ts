...
export const defaultTranslations: Record<string, TranslationDictionary> = {
  pl: {
    ...
    searchingEngine: 'Szukanie aktywnej instancji silnika OxyFlow...',
    connectingSqlite: 'Łączenie z bazą sqlite3 i analizowanie rozpoczętych wierszy logs.',
    connectedDaemon: 'Połączono z daemonem OxyFlow',
  ...
  en: {
    ...
    searchingEngine: 'Searching for active OxyFlow engine instance...',
    connectingSqlite: 'Connecting to sqlite3 database and analyzing active log rows.',
    connectedDaemon: 'Connected to OxyFlow Daemon',
  ...
  es: {
    ...
    searchingEngine: 'Buscando instancia activa del motor OxyFlow...',
    connectingSqlite: 'Conectando a la base de datos sqlite3 y analizando registros activos.',
    connectedDaemon: 'Conectado al demonio OxyFlow',
  ...
  'pt-br': {
    ...
    searchingEngine: 'Buscando instância ativa do motor OxyFlow...',
    connectingSqlite: 'Conectando ao banco de dados sqlite3 e analisando as linhas ativas de registro.',
    connectedDaemon: 'Conectado ao daemon OxyFlow',
